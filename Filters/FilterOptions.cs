...
namespace Integrador.Iugu.Filters
{
    ...
    public class QueryStringFilter : IQueryStringFilter
    {
        ...
        private readonly Dictionary<string, string> FilterParams = new Dictionary<string, string>
        {
            ...
            [nameof(StatusFilter)] = "status_filter={0}",
            [nameof(AditionalParameters)] = "{0}",
        };
        ...
        private InvoiceAvailableStatus status_filter;
        [JsonProperty("status_filter")]
        public InvoiceAvailableStatus StatusFilter
        {
            ...
            set
            {
                ...
                AppendFilter(nameof(StatusFilter), Enum.GetName(typeof(InvoiceAvailableStatus), value).ToString().ToLower());
            }
        }

        private string parameters;
        [JsonProperty("parameters")]
        public string AditionalParameters
        {
            ...
            set
            {
                ...
                {
                    AppendFilter(nameof(AditionalParameters), value);
                }
            }
        }
