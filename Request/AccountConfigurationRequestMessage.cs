...
namespace Integrador.Iugu.Request
{
    public class AccountConfigurationRequestMessage
    {
        ...
        public bool? Payment_email_notification { get; set; }
        ...
        public string Payment_email_notification_receiver { get; set; }

        /// <summary>
        /// Desabilita saque da subconta
        /// </summary>
        [JsonProperty("disabled_withdraw")]
        public bool? Disabled_withdraw { get; set; }
    }
